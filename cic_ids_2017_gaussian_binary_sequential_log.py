...
clf = GaussianMixture(
    n_components=2, covariance_type="full", max_iter=100, random_state=0, init_params='k-means++'
    , reg_covar=1e-6
)
...
logging.info("Selected Features: %s", sfs.get_support())
...
logging.info("Average Accuracy: %s", average_accuracy)
